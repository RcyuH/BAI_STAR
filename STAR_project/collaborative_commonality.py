...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 21 16:37:01 2025
...
def main():
    ...
    # Make a mapping
    items_id_unique = ["item1", "item2", "item3"]
    item_to_idx = {item: idx for idx, item in enumerate(items_id_unique)}
    
    # Initialize processor
    processor = CollaborativeRelationshipProcessor()
    
    # Process interactions
    processor.process_interactions(interactions, item_to_idx)
